                                ...
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    ...
                                    <form class="space-y-4 md:space-y-6" action="" method="POST">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Type here" class="input input-bordered w-full max-w" />
                                        </div>

                                        <div>
                                            <label for="password" class="block mb-2 text-sm font-medium text-white">Username</label>
                                            <input type="text" placeholder="Type here" class="input input-bordered w-full max-w" />
                                        </div>
