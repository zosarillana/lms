        ...
        <table class="table table-lg border-none">
            ...
            <thead class="bg-blue-500 text-white">
                <tr>
                    ...
                    <th class="border-b border-gray-200">Scheduled Time</th>
                    <th class="border-b border-gray-200">Scheduled Day</th>
            ...
            <tbody class="bg-gray-50 text-black ">
                ...
                <tr class="hover:bg-slate-200">
                    ...
                    <td class="border-b text-sm border-gray-200">Filipino</td>
                    <td class="border-b text-sm border-gray-200">BSIT</td>
                    <td class="border-b text-sm border-gray-200">NaN</td>
                    <td class="border-b text-sm border-gray-200">NaN</td>
